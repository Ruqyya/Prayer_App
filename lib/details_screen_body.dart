...
import 'package:lil_sikhapp/read_more_screen.dart';
...
class Details_Body extends StatelessWidget {
  ...
  const Details_Body({Key? key, required this.item}) : super(key: key);
    ...
    return Container(
      ...
      child: Column(
        children: [
          Padding(
            padding: const EdgeInsets.symmetric(horizontal: kdefaultPaddin),
            child: Text(
              " Those who listen to the Guru, eat and are totally satisfied.",
          ...
          Padding(
            ...
            child: Text(
              "Nanak bhusaria pakaaeeaa paaeeaa thaale mahe.",
              textAlign: TextAlign.center,
              style: TextStyle(
                fontSize: 18,
              ),
      ...
      decoration: BoxDecoration(
        image: DecorationImage(
          image: AssetImage('assets/icons/english_language_box.png'),
          fit: BoxFit.fill,
        ),
      ),
    );
  ...
  Padding hindi_text_box() {
    return Padding(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          image: DecorationImage(
            image: AssetImage('assets/icons/hindi_language_box.png'),
            fit: BoxFit.fill,
          ),
        ),
      ),
